...
function processDir(dir, opts) {
    ...
    try {
        var cfg = require(path.resolve(dir, "pigcfg.json"));
        extend(opts, cfg, false);
    } catch (e) {
    ...
    return readDir(dir)
        .then(function(files) {
            ...
            // automatically
            opts.omitPrefix = opts.omitPrefix !== undefined ? opts.omitPrefix : detectCommonPrefix(svgFiles);
